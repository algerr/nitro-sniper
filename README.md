...
- A: [Installation](https://github.com/algerr/nitro-sniper/wiki/Installation)

<br />

- **Q: Where can I find the default configuration?**
- A: [Default Configuration](https://github.com/algerr/nitro-sniper/wiki/Default-Configuration)
